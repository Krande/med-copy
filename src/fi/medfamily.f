...
cDEC$ ATTRIBUTES DLLEXPORT :: mfacre
c
      implicit none
      save
c
...
cDEC$ ATTRIBUTES DLLEXPORT :: mfanfa
c
      implicit none
      save
c
...
cDEC$ ATTRIBUTES DLLEXPORT :: mfanfg
c
      implicit none
      save
c
...
cDEC$ ATTRIBUTES DLLEXPORT :: mfafai
c
      implicit none
      save
c 
...
cDEC$ ATTRIBUTES DLLEXPORT :: mfaona
c
      implicit none
      save
c
...
c
     ...
     &                  num,gro,cret)
cDEC$ ATTRIBUTES DLLEXPORT :: mfaofi
c
      implicit none
      save
c 
