...
/**\ingroup MEDfile
  \brief \MEDfileObjectDescriptionWrByPathBrief
  \param fid \fid
  \param medpath \medpath
  \param description \description
  \retval med_err  \error
  \details \MEDfileObjectDescriptionWrByPathDetails
  \par Remarques
		                 ...
		                 const char     * const description)
{
  ...
  if (  _MEDattributeStringWrByName(fid,
				    medpath->_datagroupname,
				    MED_NOM_DES,
				    MED_COMMENT_SIZE,
				    description ) <0 ) {
    MED_ERR_(_ret,MED_ERR_CALL,MED_ERR_API,"_MEDattributeStringWrByName");
