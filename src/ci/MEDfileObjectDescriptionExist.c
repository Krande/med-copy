...
/**\ingroup MEDfile
  \brief \MEDfileObjectDescriptionExistBrief
  \param fid \fid
  \param medclass \medclass
  \param objectname \objectname
  \param descriptionexist \descriptionexist
  \retval med_err  \error
  \details \MEDfileObjectDescriptionExistDetails
  \par Remarques
			            ...
			            med_bool  * const descriptionexist)
{
  ...
  *descriptionexist = MED_FALSE;
  ...
  switch(medclass) {
    ...
    /* MEDmodel/MEDfile/FAS/<FAMILY_MESH_NAME_REF>/_ELEME/<FAMILY_NAME_ELEM>/_GRO/<GROUPNAME>  */
    /* Une première solution pourrait être une liste de noms séparés par le caractère '/' :    */
    /* objectname == <FAMILY_MESH_NAME_REF>/<FAMILY_NAME_ELEM>/<GROUPNAME>                     */
