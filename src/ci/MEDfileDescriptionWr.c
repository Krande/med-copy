...
/**\ingroup MEDfile
  \brief \MEDfileDescriptionWrBrief
  \param fid \fid
  \param description \description
  \retval med_err \error
  \details \MEDfileDescriptionWrDetails
 */
		     ...
		     const char* const description)
{
 ...
 if (_MEDcheckVersion30(fid) < 0) goto ERROR;
  ...
  /* The description is stored in a HDF attribute */
  if (_MEDattributeStringWr(_rootId,MED_COMMENT_NAME,MED_COMMENT_SIZE,(char*)description) < 0) {
