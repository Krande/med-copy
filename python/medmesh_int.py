...
MED_41_LATEST_RELEASE = _medmesh.MED_41_LATEST_RELEASE
...
MED_LNAME_BLANK = _medmesh.MED_LNAME_BLANK
...
MED_FAMILY_ZERO = _medmesh.MED_FAMILY_ZERO
MED_FAMILY_NODE = _medmesh.MED_FAMILY_NODE
MED_FAMILY_ELEM = _medmesh.MED_FAMILY_ELEM
...
MED_MAX_NAME_IN_PATH = _medmesh.MED_MAX_NAME_IN_PATH
MED_MAX_DATAGROUPNAME_IN_PATH = _medmesh.MED_MAX_DATAGROUPNAME_IN_PATH
class med_path(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    medclass = property(_medmesh.med_path_medclass_get, _medmesh.med_path_medclass_set)
    nname = property(_medmesh.med_path_nname_get, _medmesh.med_path_nname_set)
    name = property(_medmesh.med_path_name_get, _medmesh.med_path_name_set)
    _datagroupname = property(_medmesh.med_path__datagroupname_get, _medmesh.med_path__datagroupname_set)

    def __init__(self):
        r"""__init__(self) -> med_path"""
        _medmesh.med_path_swiginit(self, _medmesh.new_med_path())
    __swig_destroy__ = _medmesh.delete_med_path

# Register med_path in _medmesh:
_medmesh.med_path_swigregister(med_path)
