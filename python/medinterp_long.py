...
MED_41_LATEST_RELEASE = _medinterp.MED_41_LATEST_RELEASE
...
MED_LNAME_BLANK = _medinterp.MED_LNAME_BLANK
...
MED_FAMILY_ZERO = _medinterp.MED_FAMILY_ZERO
MED_FAMILY_NODE = _medinterp.MED_FAMILY_NODE
MED_FAMILY_ELEM = _medinterp.MED_FAMILY_ELEM
...
MED_MAX_NAME_IN_PATH = _medinterp.MED_MAX_NAME_IN_PATH
MED_MAX_DATAGROUPNAME_IN_PATH = _medinterp.MED_MAX_DATAGROUPNAME_IN_PATH
class med_path(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    medclass = property(_medinterp.med_path_medclass_get, _medinterp.med_path_medclass_set)
    nname = property(_medinterp.med_path_nname_get, _medinterp.med_path_nname_set)
    name = property(_medinterp.med_path_name_get, _medinterp.med_path_name_set)
    _datagroupname = property(_medinterp.med_path__datagroupname_get, _medinterp.med_path__datagroupname_set)

    def __init__(self):
        r"""__init__(self) -> med_path"""
        _medinterp.med_path_swiginit(self, _medinterp.new_med_path())
    __swig_destroy__ = _medinterp.delete_med_path

# Register med_path in _medinterp:
_medinterp.med_path_swigregister(med_path)
