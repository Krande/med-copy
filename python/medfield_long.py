...
MED_41_LATEST_RELEASE = _medfield.MED_41_LATEST_RELEASE
...
MED_LNAME_BLANK = _medfield.MED_LNAME_BLANK
...
MED_FAMILY_ZERO = _medfield.MED_FAMILY_ZERO
MED_FAMILY_NODE = _medfield.MED_FAMILY_NODE
MED_FAMILY_ELEM = _medfield.MED_FAMILY_ELEM
...
MED_MAX_NAME_IN_PATH = _medfield.MED_MAX_NAME_IN_PATH
MED_MAX_DATAGROUPNAME_IN_PATH = _medfield.MED_MAX_DATAGROUPNAME_IN_PATH
class med_path(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    medclass = property(_medfield.med_path_medclass_get, _medfield.med_path_medclass_set)
    nname = property(_medfield.med_path_nname_get, _medfield.med_path_nname_set)
    name = property(_medfield.med_path_name_get, _medfield.med_path_name_set)
    _datagroupname = property(_medfield.med_path__datagroupname_get, _medfield.med_path__datagroupname_set)

    def __init__(self):
        r"""__init__(self) -> med_path"""
        _medfield.med_path_swiginit(self, _medfield.new_med_path())
    __swig_destroy__ = _medfield.delete_med_path

# Register med_path in _medfield:
_medfield.med_path_swigregister(med_path)
