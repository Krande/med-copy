...
MED_41_LATEST_RELEASE = _medenum.MED_41_LATEST_RELEASE
...
MED_LNAME_BLANK = _medenum.MED_LNAME_BLANK
...
MED_FAMILY_ZERO = _medenum.MED_FAMILY_ZERO
MED_FAMILY_NODE = _medenum.MED_FAMILY_NODE
MED_FAMILY_ELEM = _medenum.MED_FAMILY_ELEM
...
MED_MAX_NAME_IN_PATH = _medenum.MED_MAX_NAME_IN_PATH
MED_MAX_DATAGROUPNAME_IN_PATH = _medenum.MED_MAX_DATAGROUPNAME_IN_PATH
class med_path(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    medclass = property(_medenum.med_path_medclass_get, _medenum.med_path_medclass_set)
    nname = property(_medenum.med_path_nname_get, _medenum.med_path_nname_set)
    name = property(_medenum.med_path_name_get, _medenum.med_path_name_set)
    _datagroupname = property(_medenum.med_path__datagroupname_get, _medenum.med_path__datagroupname_set)

    def __init__(self):
        _medenum.med_path_swiginit(self, _medenum.new_med_path())
    __swig_destroy__ = _medenum.delete_med_path

# Register med_path in _medenum:
_medenum.med_path_swigregister(med_path)
...
class MED_CLASS(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    val = property(_medenum.MED_CLASS_val_get, _medenum.MED_CLASS_val_set)

    def __init__(self, *args):
        _medenum.MED_CLASS_swiginit(self, _medenum.new_MED_CLASS(*args))

    def __str__(self):
        return _medenum.MED_CLASS___str__(self)
    __swig_destroy__ = _medenum.delete_MED_CLASS

# Register MED_CLASS in _medenum:
_medenum.MED_CLASS_swigregister(MED_CLASS)

MED_CLASS.__repr__= lambda self:"MED_CLASS" +"("+str(self.val)+")"
